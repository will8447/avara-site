...
- **Apple purchases:** Apple handles payment details. The app checks StoreKit entitlements to unlock Premium. Cloud sign-in does not transfer purchases between different purchasing Apple Accounts. Verified purchase history is checked locally to restore lifetime Premium and recognise eligible previous subscribers; we do not send that history to AdMob.

### Advertising on the free plan

From the upcoming 1.2.0 update, free use may display clearly labelled native ads on Today, supplied by Google AdMob. Premium users, including recognised previous paying subscribers, do not receive ad requests or ad displays. We check purchase access before requesting an ad. We do not send your shifts, bills, balances, notes, cloud account identity or commute coordinates to AdMob, and we do not use those records to select ads.

The Google Mobile Ads and User Messaging Platform SDKs process technical information needed to deliver, measure and protect advertising: IP address (which may infer approximate location), app/device information and identifiers permitted by your device settings, ad interactions, consent choices, and diagnostic/performance information such as crash or launch data. We request non-personalised ads, disable publisher first-party identifiers and do not request Apple's cross-app tracking permission or provide an advertising ID ourselves. These settings do not mean ad delivery involves no data collection. See [Google's SDK data disclosure](https://developers.google.com/admob/ios/privacy/data-disclosure) and [Google's advertising privacy information](https://policies.google.com/technologies/ads).

Where required, a consent message appears before an ad can be requested. Use Settings → Ad privacy choices to manage or withdraw consent when that option is applicable. Declining optional consent keeps your planner available; Google may supply restricted ads where permitted, or no ad. Google's policies govern its retention, security, international processing and advertising partners. You can also contact us with privacy questions or choose the one-time ad-free Premium unlock.
...
- Premium is a one-time purchase from version 1.2.0. Manage refunds through Apple, and cancel any previous renewing subscription in your Apple Account settings. Cloud-account deletion does not remove your Apple purchase history.
