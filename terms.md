...
- Attempt to bypass rate limits, daily AI usage caps, trial-period checks, subscription validation, or any other technical control.
...
- **Premium Monthly** — £3.99 per month (or local equivalent set by the App Store).
- **Premium Yearly** — £29.99 per year (or local equivalent set by the App Store).
...
- Free trial: **5 AI messages per day**.
- Premium: **60 AI messages per day**.
...
- **AI responses can be inaccurate, incomplete or out of date.** You must verify anything important before relying on it.
- **Avara AI does not provide financial, tax, legal, medical, employment, or professional advice.** Its output is for general informational and productivity purposes only. For decisions that matter, consult a qualified professional.
- **Avara AI may misinterpret your data.** Always review any actions it suggests (such as creating a bill, scheduling a shift, or adding an event) before confirming them in the App.
- **You are responsible for the content you send to the assistant** and for any actions you take based on its responses.
- **You must not** send Avara AI content that is unlawful, abusive, harassing, defamatory, hateful, infringing, sexually explicit involving minors, or that contains malware or attempts to manipulate, jailbreak, or extract our system instructions.
- **You must not** use Avara AI to generate content that violates OpenAI's usage policies (https://openai.com/policies/usage-policies).
...
- Use Avara to engage in or facilitate any unlawful activity.
...
- Use Avara to harass, threaten, defame, or harm another person.
...
- **Apple** — App Store, StoreKit, iOS, EventKit, CloudKit and the Keychain.
- **OpenAI** — model and transcription APIs powering Avara AI.
- **Vercel** — backend hosting.
- **Upstash** — backend cache.
